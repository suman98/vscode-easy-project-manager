...
exports.ProjectWebviewProvider = void 0;
    ...
    async handleMessage(msg) {
        ...
        switch (msg.type) {
            ...
            case 'moveToOrg': {
                ...
                const org = await (0, addProject_1.pickOrganization)(this.projectService, project.organization);
                if (org === undefined) {
                    return;
                }
            ...
            case 'remove': {
                ...
                const confirm = await vscode.window.showWarningMessage(`Remove "${project.name}" from Project Manager?`, { modal: true }, 'Remove');
                if (confirm !== 'Remove') {
                    return;
                }
            ...
            case 'renameOrg': {
                ...
                if (!newName || newName.trim() === msg.org) {
                    return;
                }
            ...
            case 'deleteOrg': {
                const confirm = await vscode.window.showWarningMessage(`Delete organization "${msg.org}"? Projects inside will be moved to No Organization.`, { modal: true }, 'Delete');
                if (confirm !== 'Delete') {
                    return;
                }
...
exports.ProjectWebviewProvider = ProjectWebviewProvider;
ProjectWebviewProvider.viewType = 'projectManagerView';
//# sourceMappingURL=ProjectWebviewProvider.js.map